/* -----------------------------------------------------------------------------
    ...
    This class is from CSharp_MARC (https://github.com/afrozenpeach/CSharp_MARC)
    by Mattie Schraeder which is based on the File_MARC package
    (http://pear.php.net/package/File_MARC) by Dan Scott, which was based on the
    PHP MARC package, originally called "php-marc", that is part of the
    Emilda Project (http://www.emilda.org).

    GetChars() and AppendUnicodeCharacter based on code from SobekCM() Marc
    Library https://sourceforge.net/projects/marclibrary/

    In all instances, the source code found in this file for the MARC8 class is
    released under the GNU Lesser General Public License, which comes with the
    following notice
    ...
    It is my understanding that by using this class file, this will fall under
    the "5. Combined Libraries" section of the license.  As such, I have in
    good faith given promenant notice that this is based on CSharp_Marc by
    Mattie Schraeder, which again can be found at
    https://github.com/afrozenpeach/CSharp_MARC and have conveyed this
    class file under the same GNU LGPL License.
